 ...
 */
@MappedSuperclass
@Table(name = "miocardreal")
@XmlRootElement
public class MiocardrealEntitiy implements Serializable {
    ...
    public MiocardrealEntitiy() {
    }

    public MiocardrealEntitiy(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MiocardrealEntitiy)) {
            return false;
        }
        MiocardrealEntitiy other = (MiocardrealEntitiy) object;
