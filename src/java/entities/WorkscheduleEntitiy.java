...
@XmlRootElement
public class WorkscheduleEntitiy implements Serializable {
    ...
    public WorkscheduleEntitiy() {
    }

    public WorkscheduleEntitiy(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof WorkscheduleEntitiy)) {
            return false;
        }
        WorkscheduleEntitiy other = (WorkscheduleEntitiy) object;
    ...
    public String toString() {
        return "entities.WorkscheduleEntitiy[ id=" + id + " ]";
    }
